...
# Binary_sensor:  Switch, Opening, Light, Moisture, Motion, Sensor Light, Battery
#                            sensor                       binary
# Measurement type      [T  H  M  C  I  F  Cn V  B]  [Sw O  L  Mo Mn Sl B]     (start from 0, 9 - no data)
MMTS_DICT = {
    'LYWSDCGQ'       : [[0, 1, 9, 9, 9, 9, 9, 9, 2], [9, 9, 9, 9, 9, 9, 9]],
    'CGG1'           : [[0, 1, 9, 9, 9, 9, 9, 9, 2], [9, 9, 9, 9, 9, 9, 9]],
    'CGG1-ENCRYPTED' : [[0, 1, 9, 9, 9, 9, 9, 9, 2], [9, 9, 9, 9, 9, 9, 9]],
    'CGDK2'          : [[0, 1, 9, 9, 9, 9, 9, 9, 2], [9, 9, 9, 9, 9, 9, 9]],
    'LYWSD02'        : [[0, 1, 9, 9, 9, 9, 9, 9, 2], [9, 9, 9, 9, 9, 9, 9]],
    'LYWSD03MMC'     : [[0, 1, 9, 9, 9, 9, 9, 3, 2], [9, 9, 9, 9, 9, 9, 9]],
    'CGD1'           : [[0, 1, 9, 9, 9, 9, 9, 9, 2], [9, 9, 9, 9, 9, 9, 9]],
    'MHO-C401'       : [[0, 1, 9, 9, 9, 9, 9, 9, 2], [9, 9, 9, 9, 9, 9, 9]],
    'MHO-C303'       : [[0, 1, 9, 9, 9, 9, 9, 9, 2], [9, 9, 9, 9, 9, 9, 9]],
    'JQJCY01YM'      : [[0, 1, 9, 9, 9, 2, 9, 9, 3], [9, 9, 9, 9, 9, 9, 9]],
    'HHCCJCY01'      : [[0, 9, 1, 2, 3, 9, 9, 9, 9], [9, 9, 9, 9, 9, 9, 9]],
    'GCLS002'        : [[0, 9, 1, 2, 3, 9, 9, 9, 9], [9, 9, 9, 9, 9, 9, 9]],
    'HHCCPOT002'     : [[9, 9, 0, 1, 9, 9, 9, 9, 9], [9, 9, 9, 9, 9, 9, 9]],
    'WX08ZM'         : [[9, 9, 9, 9, 9, 9, 0, 9, 1], [0, 9, 9, 9, 9, 9, 1]],
    'MCCGQ02HL'      : [[9, 9, 9, 9, 9, 9, 9, 9, 0], [9, 0, 1, 9, 9, 9, 2]],
    'YM-K1501'       : [[0, 9, 9, 9, 9, 9, 9, 9, 9], [0, 9, 9, 9, 9, 9, 9]],
    'YM-K1501EU'     : [[0, 9, 9, 9, 9, 9, 9, 9, 9], [0, 9, 9, 9, 9, 9, 9]],
    'V-SK152'        : [[0, 9, 9, 9, 9, 9, 9, 9, 9], [0, 9, 9, 9, 9, 9, 9]],
    'SJWS01LM'       : [[9, 9, 9, 9, 9, 9, 9, 9, 0], [9, 9, 9, 0, 9, 9, 1]],
    'MJYD02YL'       : [[9, 9, 9, 9, 9, 9, 9, 9, 0], [9, 9, 0, 9, 1, 2, 3]],
}
